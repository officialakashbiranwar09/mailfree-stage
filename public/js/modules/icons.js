...
const IconHelper = {
   ...
   * @param {number} width - 宽度（default 18）
   * @param {number} height - 高度（default 18）
  ...
  /**
   * Create带 icon 的按钮 HTML
   * @param {string} text - 按钮文本
   * @param {string} iconId - 图标 ID
   * @param {string} btnClass - 按钮类名（default 'btn btn-ghost'）
  ...
  /**
   * Create带 icon 的链接 HTML
   * @param {string} text - 链接文本
   * @param {string} iconId - 图标 ID
   * @param {string} href - 链接地址
   * @param {string} linkClass - 链接类名（default 'btn btn-ghost'）
